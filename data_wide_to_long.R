...
shapefile_data_unique <- wide_data %>%
  ...
  # Select the fields to retain in the shapefile along with the new unique ID
  select(app_id, num_apps, block_1, block_2, block_3, block_4, 
         year, province, map_nam, app_type, aircraft, guidance, app_sys, reference, Shape_Leng, Shape_Area)
